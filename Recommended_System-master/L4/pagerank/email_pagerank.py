...
aliases = {}
for index, row in file.iterrows():  #iterrows()返回索引和行对象组成的元组
...
print(emails.MetadataTo[:30])
# 设置边的权重等于发邮件的次数
edges_weights_temp = dict() #defaultdict(list)
...
print('edges_weights_temp:'+'\n',list(edges_weights_temp.items())[:2])
print('-'*100)
